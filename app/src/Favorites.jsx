...
// import { FavoriteButton } from './Results'
    ...
    <>
      ...
      {favorites.map((favorite) => (
        <article className={css.result}>
          <div className='favs'>
            {/* <FavoriteButton isFavorite job_id={favorite.job_id} /> */}
          </div>
          <div key={favorite.listing_id}>
            <h3><a href={favorite['job_link']} target='_blank' rel='noreferrer'>{favorite.job_title} <svg xmlns="http://www.w3.org/2000/svg" width="682.7" height="682.7" version="1.0" viewBox="0 0 512 512">
            ...
            <p>Salary: {!favorite.salary ? 'Not provided' : favorite.salary}</p>
          </div>
        </article>
      ))}
    </>
